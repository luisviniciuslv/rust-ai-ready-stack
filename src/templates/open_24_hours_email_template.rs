pub const OPEN_24_HOURS_EMAIL_TEMPLATE: &str = r#"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
              ...
              <tbody>
                <tr style="width:100%">
                  <td>
                    ...
                    >
                      CHAMADO em aberto há mais de 24 horas
                    </h1>
                    <p
                    ...
                    <p
                      style="font-size:12px;line-height:20px;color:rgb(110,110,110);letter-spacing:0;padding:0 30px;margin:0;text-align:center"
                    >
                      Ticket criado em: __TICKET_CREATED_AT__
                    </p>
                  </td>
                </tr>
              </tbody>
